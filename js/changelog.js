...
window.CHANGELOG = [
  {
    ...
    voci: [
      ...
      { tipo:'nuovo',  t:'Quattro superfici per rifarti il podere come vuoi', d:'C\'era il Sentiero di Pietra e basta, quindi un podere personale aveva un colore solo; e soprattutto non esisteva il verso opposto — una casella diventata terra battuta o sentiero non tornava più prato in nessun modo. Adesso al banco da lavoro si fanno anche <b>Assi da Pavimento</b> (i passi ci suonano sopra), <b>Lastre di Pietra</b> per i cortili, <b>Mattonelle di Cotto</b> per l\'aia, e soprattutto le <b>Zolle d\'Erba</b>, che rifanno prato dove c\'è terra o una pavimentazione che non ti piace più. Si posano una casella per volta come il sentiero, si passano una sopra l\'altra, e i bordi si raccordano da soli con le caselle vicine. Costano poco di proposito: è una scelta di gusto, non un traguardo da guadagnare.' },
